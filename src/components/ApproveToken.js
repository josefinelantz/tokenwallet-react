/*
Renders the wallet screen for the Approve screen. It loads when the user clicks the approve button. For ERC20 tokens, it asks for the address to approve and the balance to approve for that address. For ERC721, it asks for the address to approve and the token ID to approve.
*/
