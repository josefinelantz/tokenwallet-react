/*
Renders the wallet screen for the Mint screen. It loads when the user clicks the mint button. For ERC20 tokens, it asks for the address it needs to send new tokens to and the number of tokens to mint. For ERC721, it asks for the address to which the new NFT will be tagged and the metadata for the new token. 
*/
